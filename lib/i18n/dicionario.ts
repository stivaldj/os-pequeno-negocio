...
export const DICIONARIO: Traducoes = {
  ...
  // Coexistência (ADR-0015): botão do Embedded Signup na tela do canal oficial.
  "Conectar pelo WhatsApp Business": { es: "Conectar por WhatsApp Business" },
  "Entre com a conta da Meta e escolha o número que já está no aplicativo WhatsApp Business. O app": { es: "Ingresa con la cuenta de Meta y elige el número que ya está en la aplicación WhatsApp Business. La app" },
  "continua funcionando no telefone": { es: "sigue funcionando en el teléfono" },
  " — o sistema passa a receber e responder pelo mesmo número, sem token para copiar.": { es: " — el sistema pasa a recibir y responder por el mismo número, sin token que copiar." },
  "Conexão cancelada antes de terminar. Nada foi alterado.": { es: "Conexión cancelada antes de terminar. No se cambió nada." },
  "A Meta devolveu um erro durante a conexão.": { es: "Meta devolvió un error durante la conexión." },
  "Não foi possível carregar o SDK da Meta. Verifique bloqueadores e tente de novo.": { es: "No se pudo cargar el SDK de Meta. Revisa los bloqueadores e inténtalo de nuevo." },
  "Aguardando a Meta…": { es: "Esperando a Meta…" },
  "Entrar com a conta da Meta": { es: "Ingresar con la cuenta de Meta" },
  ...
  // ─── Anúncios (Fase 5): Google Ads, Sobra por Real, links de captura, propostas ───
  "Anúncios": { es: "Anuncios" },
  "Google Ads: quanto cada campanha devolve por real gasto, links de captura e propostas do agente.": { es: "Google Ads: cuánto devuelve cada campaña por real gastado, enlaces de captura y propuestas del agente." },
  "Conta do Google Ads": { es: "Cuenta de Google Ads" },
  "O ID do cliente e a ação de conversão que recebe os agendamentos pagos.": { es: "El ID de cliente y la acción de conversión que recibe las citas pagadas." },
  "ID do cliente (10 dígitos)": { es: "ID de cliente (10 dígitos)" },
  "Cliente da conversão (opcional)": { es: "Cliente de la conversión (opcional)" },
  ...
  "7 dias": { es: "7 días" },
  "30 dias": { es: "30 días" },
  "Nenhuma campanha com gasto ou contato no período.": { es: "Ninguna campaña con gasto o contacto en el período." },
  "Campanha": { es: "Campaña" },
  "Gasto": { es: "Gasto" },
  "Cliques": { es: "Clics" },
  "Agendamentos": { es: "Citas" },
  "Receita": { es: "Ingresos" },
  "Sobra por Real": { es: "Sobra por Real" },
  "Dados": { es: "Datos" },
  "por real": { es: "por real" },
  "dia(s) sem gasto": { es: "día(s) sin gasto" },
  "Completo": { es: "Completo" },
  "Links de captura": { es: "Enlaces de captura" },
  "A URL final de cada anúncio. Quem clica cai no WhatsApp com a mensagem pronta, e o contato chega atribuído à campanha.": { es: "La URL final de cada anuncio. Quien hace clic cae en WhatsApp con el mensaje listo, y el contacto llega atribuido a la campaña." },
  "Nenhum link ainda. Crie um por campanha.": { es: "Ningún enlace todavía. Cree uno por campaña." },
  "Não foi possível copiar. Selecione e copie o endereço.": { es: "No se pudo copiar. Seleccione y copie la dirección." },
  "ID da campanha no Google": { es: "ID de la campaña en Google" },
  "Nome da campanha": { es: "Nombre de la campaña" },
  "WhatsApp de destino (E.164)": { es: "WhatsApp de destino (E.164)" },
  "Mensagem pré-escrita": { es: "Mensaje preescrito" },
  "Criar link": { es: "Crear enlace" },
  "Link de captura criado.": { es: "Enlace de captura creado." },
  "Propostas do agente": { es: "Propuestas del agente" },
  "O agente propõe; quem decide é você. Nada muda no Google sem aprovação.": { es: "El agente propone; quien decide es usted. Nada cambia en Google sin aprobación." },
  "Nenhuma proposta pendente.": { es: "Ninguna propuesta pendiente." },
  "Palavra-chave": { es: "Palabra clave" },
  "Anúncio": { es: "Anuncio" },
  "Observação": { es: "Observación" },
  "Recusar": { es: "Rechazar" },
  "Proposta aprovada.": { es: "Propuesta aprobada." },
  "Proposta recusada.": { es: "Propuesta rechazada." },
  // ─── Financeiro (Fase 6): extrato OFX, caixa por conta, contas a pagar e a receber ───
  //
  // "incompleto" e "Sem total" NÃO viram zero em idioma nenhum: a tela diz em
  // palavras que falta dado, e a tradução tem de dizer o mesmo. Um "0,00" no
  // espanhol afirmaria que a conta está zerada.
  "Financeiro": { es: "Finanzas" },
  "Importe o extrato do banco em OFX e veja quanto tem em caixa, o que vence hoje e o que já venceu.": { es: "Importe el extracto del banco en OFX y vea cuánto hay en caja, qué vence hoy y qué ya venció." },
  "Importar extrato": { es: "Importar extracto" },
  "Caixa por conta": { es: "Caja por cuenta" },
  "O saldo é o que o BANCO declarou no extrato, com a data em que ele valia — não a soma dos lançamentos importados. O que entrou depois dessa data aparece à parte.": { es: "El saldo es el que el BANCO declaró en el extracto, con la fecha en que valía — no la suma de los movimientos importados. Lo que entró después de esa fecha aparece aparte." },
  "Total em caixa": { es: "Total en caja" },
  "Sem total: alguma conta está incompleta.": { es: "Sin total: alguna cuenta está incompleta." },
  "Nenhum extrato importado ainda. Comece por “Importar extrato”.": { es: "Ningún extracto importado todavía. Empiece por “Importar extracto”." },
  "Saldo do banco": { es: "Saldo del banco" },
  "Depois desse saldo": { es: "Después de ese saldo" },
  "Estimado hoje": { es: "Estimado hoy" },
  "Cartão de crédito": { es: "Tarjeta de crédito" },
  "Conta bancária": { es: "Cuenta bancaria" },
  "incompleto": { es: "incompleto" },
  "lançamento(s)": { es: "movimiento(s)" },
  "Conta marcada como incompleta nunca teve saldo lido do banco: o extrato importado não trouxe o saldo declarado. Ela fica de fora do total até que um extrato com saldo chegue.": { es: "Una cuenta marcada como incompleta nunca tuvo saldo leído del banco: el extracto importado no trajo el saldo declarado. Queda fuera del total hasta que llegue un extracto con saldo." },
  "O que vence": { es: "Lo que vence" },
  "O dia é o do fuso da sua organização, não o do servidor. Só contas em aberto entram aqui.": { es: "El día es el del huso horario de su organización, no el del servidor. Solo entran aquí las cuentas pendientes." },
  "A pagar": { es: "A pagar" },
  "A receber": { es: "A cobrar" },
  "Já venceu": { es: "Ya venció" },
  "Nada vencido em aberto.": { es: "Nada vencido pendiente." },
  "Vence hoje": { es: "Vence hoy" },
  "Nada vence hoje.": { es: "Nada vence hoy." },
  "Próximos 7 dias": { es: "Próximos 7 días" },
  "Nada nos próximos 7 dias.": { es: "Nada en los próximos 7 días." },
  "Contas a pagar e a receber": { es: "Cuentas a pagar y a cobrar" },
  "O valor é sempre positivo: quem diz pagar ou receber é a direção. A baixa é manual — o sistema não adivinha qual lançamento do extrato pagou qual conta.": { es: "El valor siempre es positivo: quien dice pagar o cobrar es la dirección. La baja es manual — el sistema no adivina qué movimiento del extracto pagó qué cuenta." },
  "Nenhuma conta em aberto.": { es: "Ninguna cuenta pendiente." },
  "Marcar como paga": { es: "Marcar como pagada" },
  "Marcar como recebida": { es: "Marcar como cobrada" },
  "Direção": { es: "Dirección" },
  "Digite o valor em reais, por exemplo 1.250,00.": { es: "Escriba el valor en reales, por ejemplo 1.250,00." },
  "Cadastrando…": { es: "Registrando…" },
  "Cadastrar conta": { es: "Registrar cuenta" },
  "Conta cadastrada.": { es: "Cuenta registrada." },
  "Conta dada por paga.": { es: "Cuenta dada por pagada." },
  "Conta cancelada.": { es: "Cuenta cancelada." },
  "Últimos lançamentos": { es: "Últimos movimientos" },
  "As linhas do extrato, como o banco as mandou. Linha marcada é linha sem identificador confiável do banco.": { es: "Las líneas del extracto, tal como el banco las mandó. Línea marcada es línea sin identificador confiable del banco." },
  "Nenhum lançamento importado ainda.": { es: "Ningún movimiento importado todavía." },
  "sem identificador do banco": { es: "sin identificador del banco" },
  "do banco": { es: "del banco" },
  "Importar extrato do banco": { es: "Importar extracto del banco" },
  "Envie o arquivo .ofx exportado pelo banco. No site do banco procure “Exportar extrato” e escolha OFX (aparece também como Money ou Quicken); PDF e planilha não servem. Importar o mesmo arquivo duas vezes não cria lançamento repetido.": { es: "Envíe el archivo .ofx exportado por el banco. En el sitio del banco busque “Exportar extracto” y elija OFX (aparece también como Money o Quicken); PDF y hoja de cálculo no sirven. Importar el mismo archivo dos veces no crea movimientos repetidos." },
  "Arquivo OFX": { es: "Archivo OFX" },
  "Não foi possível importar o extrato.": { es: "No se pudo importar el extracto." },
  "lançamento(s) no arquivo": { es: "movimiento(s) en el archivo" },
  "saldo(s) do banco gravado(s)": { es: "saldo(s) del banco guardado(s)" },
