...
- **archify** — os diagramas curados de sistema, turno do agente e flywheel viviam na pasta de arquitetura do upstream DeskcommCRM, removida no fork (ver histórico do upstream se precisar deles).
